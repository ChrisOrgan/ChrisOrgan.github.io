...
Life on planet earth evolved over billions of years. Of all the species produced in that time, 99% are now extinct. A major challenge in biology is to understand how life works when 99% of our data are missing. We are a dynamic research group at [Montana State University](https://www.montana.edu/) who aim to meet this challenge at the intersection of biology and paleontology.
...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="5000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        ...
        <div class="item">
         ...
         <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/sciphy_logo.png" alt="Slide 7" />
        </div>
    </div>
